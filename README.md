...
- **Native agent tools** — 18 tools for secrets, vaults, policies, sharing, signing keys, and multi-chain transactions (EVM + Bitcoin, Solana, XRP, Cardano, Tron; optional, configurable)
